...
function Calculation() {
  ...
  answer[0].addEventListener(
    ...
    function (event) {
      ...
      answer[0].value = new Intl.NumberFormat("en-US", {
  ...
  answer[1].addEventListener(
    ...
    function (event) {
      ...
      if (event.which >= 37 && event.which <= 40) return;
      var n = this.value.replace(/,/g, "");
      answer[1].value = new Intl.NumberFormat("en-US", {
        maximumFractionDigits: 15,
      }).format(n);
      if (event.keyCode === 190) {
        if (n.indexOf(".") == 0) {
  ...
  answer[2].addEventListener(
    ...
    function (event) {
      ...
      if (event.which >= 37 && event.which <= 40) return;
      var n = this.value.replace(/,/g, "");
      answer[2].value = new Intl.NumberFormat("en-US", {
        maximumFractionDigits: 15,
      }).format(n);
      if (event.keyCode === 190) {
        if (n.indexOf(".") == 0) {
  ...
  answer[3].addEventListener(
    ...
    function (event) {
      ...
      if (event.which >= 37 && event.which <= 40) return;
      var n = this.value.replace(/,/g, "");
      answer[3].value = new Intl.NumberFormat("en-US", {
        maximumFractionDigits: 15,
      }).format(n);
      if (event.keyCode === 190) {
        if (n.indexOf(".") == 0) {
  ...
  answer[4].addEventListener(
    ...
    function (event) {
      ...
      if (event.which >= 37 && event.which <= 40) return;
      var n = this.value.replace(/,/g, "");
      answer[4].value = new Intl.NumberFormat("en-US", {
        maximumFractionDigits: 15,
      }).format(n);
      if (event.keyCode === 190) {
        if (n.indexOf(".") == 0) {
